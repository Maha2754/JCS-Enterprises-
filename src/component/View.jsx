...
const View = ({ onClose, product }) => {
  ...
  const thumbnails = [product.img]; // Add more if available  ex const thumbnails = [product.img, product.img2, product.img3];
          ...
          <div className="right-details">
            ...
            <div className="compare-wishlist">
              ...
              <button
                ...
                onClick={() => {
                  handleWishlist();          // add/remove from wishlist
                }}
              >
                <i className={isInWishlist ? "fa-solid fa-heart" : "fa-regular fa-heart"}></i>
                {isInWishlist ? "Wishlist Added" : "Add to Wishlist"}
              </button>
            </div>
